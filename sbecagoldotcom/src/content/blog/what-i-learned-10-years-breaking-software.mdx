...
tags: ["QA career", "software testing", "lessons learned", "developer relations"]
draft: false
---
...
I'm making it EASY for them to fix it. Not making them feel bad for writing it. Learn more about [writing bug reports that get fixed](/blog/how-to-write-bug-reports-that-dont-suck).
...
**Pick your battles.**
Not every bug is worth fighting over. Save your credibility for the ones that actually matter. This is part of [what senior testers do differently](/blog/5-things-senior-testers-do-that-juniors-dont).
...
When something breaks in production, it's not just your fault. It's not just the developer's fault. Multiple people made decisions that led to that moment. Learn from it and move on. Understanding the [five stages of grief after a failed release](/blog/five-stages-of-grief-failed-release) helps you process it.
...
If your goal is to look smart, you're doing it wrong. If your goal is to help ship better software, you're doing it right. Having effective [software testing strategies](/blog/software-testing-strategies-that-arent-just-write-more-tests) helps you focus on what matters.
...
*P.S.*
*The majority of this post is based on what I experienced in my career.*
*Not all of it is me, and a good portion of it is exaggerated for the sake of storytelling.*

---

**Preparing for your next QA interview?** Check out [how Qaizzerr's progress dashboard tracks your improvement](/blog/qaizzerr-progress-dashboard-ai-explanations) with saved AI explanations and performance analysis after every quiz.
