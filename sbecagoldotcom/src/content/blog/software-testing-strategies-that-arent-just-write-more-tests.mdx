...
Happy path testing is important. But it's not where the interesting bugs live. And yes, [only testing the happy path is one of the most common QA mistakes](/blog/qa-mistakes-cpu-cooler) that leads to production fires.

### For small teams:

You don't have time to test everything. So test the stuff that's most likely to break. The new features. The integrations. The code that three different developers touched last sprint. This is where [exploratory testing](/blog/exploratory-testing-for-beginners) shines.
...
- **[Regression testing](/blog/regression-testing-explained) for stable features** - login, checkout, core workflows
...
Automate that. Test everything else manually. Understanding [manual and automation testing](/blog/manual-and-automation-testing) helps you make these decisions.
...
So make conscious decisions about what you're NOT testing. Document them. Get agreement from stakeholders. Learn [how to prioritize test cases](/blog/prioritize-test-cases-limited-time) when you're under pressure.
...
*"This spec doesn't mention what happens if the user already exists."* Understanding the [software testing life cycle](/blog/stlc-in-software-testing) helps you see where testing fits in the development process.
...
Small teams and solo testers don't have infinite time or resources. You have to be strategic. You have to prioritize. You have to make conscious decisions about what you're NOT testing. And yes, you still need to know [how to write test cases](/blog/how-to-write-test-cases-that-dont-suck) when you do write them.
