...
When you're under time pressure, knowing how to [prioritize test cases under a deadline](/blog/prioritize-test-cases-limited-time) becomes critical.
...
Sometimes you need to know [how to say no to impossible deadlines](/blog/how-to-say-no-to-impossible-deadlines) when severity assessments get political.
...
**A junior tester reports a bug like this:**

"The submit button on checkout doesn't work."

A senior tester reports the same bug like this:
...
Junior testers report what they found. Senior testers report why it matters. Learn more about [writing bug reports developers actually read](/blog/how-to-write-bug-reports-that-dont-suck).

**As a senior tester:** Learn to speak the language of business impact. "The button is broken" gets ignored. "40% of mobile users can't complete checkout" gets attention.
...
Once you've filed the bug, it enters the [defect life cycle](/blog/defect-life-cycle-explained) where severity plays a key role in prioritization.
