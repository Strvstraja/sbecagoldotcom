...
[Exploratory testing](/blog/exploratory-testing-for-beginners) becomes your best friend here. You're learning the system through experimentation.
...
And when you do this, it is extremely important to write it down again in the task or a document, an email, or a clay tablet if you like, but just make sure that there is an artefact left. When you find issues, knowing [how to write bug reports when there's no spec](/blog/how-to-write-bug-reports-that-dont-suck) is crucial. For example:
...
Your notes might even evolve into proper [test cases](/blog/how-to-write-test-cases-that-dont-suck) or requirements later; many good QA processes are born this way, but don't get your hopes too high :) and make sure you are covering enough by your tests so YOU feel comfortable letting such feature go for now.
...
If you work in a team where this is a regular thing, one-liners and chasing requirements, it is easy for you to get used to working like that. Sometimes you'll also need to know [how to say no to impossible deadlines](/blog/how-to-say-no-to-impossible-deadlines) when the lack of requirements combines with unrealistic timelines. 
