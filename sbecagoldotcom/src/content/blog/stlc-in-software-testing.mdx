...
- Identify tools ([manual/automation](/blog/manual-and-automation-testing)).
- Define risks and mitigation strategies.

Deliverables: Test plan document, resource allocation plan. Having solid [software testing strategies](/blog/software-testing-strategies-that-arent-just-write-more-tests) helps guide this phase.
...
- Test planning → strategy for [manual & automation tests](/blog/manual-and-automation-testing).
